...
ax[4].plot(x3, ysp3, 'g*')
ax[4].set(xlim=(0, 1))
plt.savefig("interpolation_comparison_sp" + suffix + ".pdf", format="pdf", dpi=300)
plt.close()
os.system("pdfcrop interpolation_comparison_sp" + suffix + ".pdf interpolation_comparison_sp" + suffix + ".pdf")
...
ax[4].set(xlim=(0, 1))
plt.savefig("interpolation_comparison_lin" + suffix + ".pdf", format="pdf", dpi=300)
plt.close()
os.system("pdfcrop interpolation_comparison_lin" + suffix + ".pdf interpolation_comparison_lin" + suffix + ".pdf")
...
ax[4].set(xlim=(0, 1))
plt.savefig("interpolation_comparison_nn" + suffix + ".pdf", format="pdf", dpi=300)
plt.close()
os.system("pdfcrop interpolation_comparison_nn" + suffix + ".pdf interpolation_comparison_nn" + suffix + ".pdf")
